...
from MyContigFilterRDP.MyContigFilterRDPImpl import MyContigFilterRDP
from MyContigFilterRDP.MyContigFilterRDPServer import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class MyContigFilterRDPTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('MyContigFilterRDP'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = MyContigFilterRDP(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_MyContigFilterRDP_" + str(suffix)
